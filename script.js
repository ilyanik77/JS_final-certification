...
// 2. Необходимо отсортировать массив products используя метод sort по цене, начиная с самой маленькой, заканчивая самой большой ценой, после чего вывести отсортированный массив консоль.
...
const photoInProducts = products2.filter(item => {
    if (item.photos != false) return item.photos;
})
console.log(photoInProducts);

const sortProducts2 = products2.sort((a, b) => {
